	...
	<div class="row"align="center" style="background-color: rgba(24, 24, 27, 0.925);">
		<div class="col-md-12">
			<div class="mu-title">
				...
				<p style="color: rgb(255, 254, 251);">ว็บไซต์ชั้นนำขายเคสโทรศัพท์มือถือ ฟิลม์และกระจกนิรภัยกันรอย เพาเะวอร์แบงค์ สายสัญญาณ สายชาร์ตโทรศัพท์ และสินค้าอื่นๆที่เกี่ยวข้อง</p>
			</div>
		</div>
	</div>
	<!-- จบส่วนหัวข้อแนะนำ -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="mu-portfolio-area">
							<br/>  
                					<?php  
                					$query = "SELECT * FROM `product` WHERE ProductType ='cable' ORDER BY ProductID ASC";  
                					$result = mysqli_query($conn, $query);  
